...
public class Constants {
    ...
    public static final String JSON_CHECKING_URL = "https://nstudiary.nstu.edu.bd/api/versionapi";
    public static final String JSON_DATA_URL = "https://nstudiary.nstu.edu.bd/api/infoapi";
